...
public class AuthorAbout extends javax.swing.JDialog {
    ...
    private static void createInstance() {
        instance = new AuthorAbout(null, true) {
            private static final long serialVersionUID = -8727959699038950953L;
            @Override
            public void dispose() {
                instance = null;
                super.dispose();
    ...
    private void initComponents() {
        ...
        labelVersion.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/x128_Size/gnome-robots-icon.png"))); // NOI18N
        ...
        labelProductNameAndVersion.setText("SDSInstagramRobot (v1.1)");
        ...
        labelWebSite.setForeground(new java.awt.Color(153, 255, 255));
    ...
    private void labelWebSiteMouseReleased(final java.awt.event.MouseEvent evt) {//GEN-FIRST:event_labelWebSiteMouseReleased
        try {
            java.awt.Desktop.getDesktop().browse(new java.net.URI("https://evertonbrunosds.github.io/sdsinstagramrobot/"));
        } catch (IOException | URISyntaxException ex) {
            JOptionPane.showMessageDialog(null, "Acesso indisponível, entre em contato com o autor.", "Mensagem de Erro!", 0);
        }
